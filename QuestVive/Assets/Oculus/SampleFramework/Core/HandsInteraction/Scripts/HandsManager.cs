...
namespace OculusSampleFramework
{
	public class HandsManager : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			//Debug.Log($"LeftHandSkeleton obj: {LeftHandSkeleton.gameObject.name}");
			...
			//Debug.Log($"RightHandSkeleton obj: {RightHandSkeleton.gameObject.name}");
		...
		public static List<OVRBoneCapsule> GetCapsulesPerBone(OVRSkeleton skeleton, OVRSkeleton.BoneId boneId)
		{
			...
			//Debug.Log($"capsules Count: {capsules.Count}");
